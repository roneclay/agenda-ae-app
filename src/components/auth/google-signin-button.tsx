...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.31 0 3.26 2.69 1.27 6.62l4 3.1C6.22 6.88 8.87 4.77 12 4.77z"
      />
    </svg>
  )
}
...
export function GoogleSignInButton() {
  ...
  return (
    <Button type="button" variant="outline" className="w-full" disabled={loading} onClick={onClick}>
      ...
      {loading ? t('google.redirecting') : t('google.button')}
    </Button>
  )
}
